...
import com.example.myapplication.data.http.entity.mi.MiAQI;
import com.example.myapplication.data.http.entity.mi.MiForecast;
import com.example.myapplication.data.http.entity.mi.MiIndex;
...
public class MiWeatherAdapter extends WeatherAdapter {
    ...
    public WeatherLive getWeatherLive() {
        return new WeatherLive(miWeather.getRealTime().getCityId(),
                ...
                miWeather.getRealTime().getWindSpeed(), DateConvertUtils.dateToTimeStamp(
                        miWeather.getRealTime().getTime(), DateConvertUtils.DATE_FORMAT_PATTEN_YYYY_MM_DD_HH_MM));
    }
    ...
    public List<WeatherForecast> getWeatherForecasts() {
        ...
        weatherForecasts.add(new WeatherForecast(miForecast.getCityId(), miForecast.getWeather1(), weathers1[0],
                weathers1[1], temps1[0], temps1[1], miForecast.getWind1(), miForecast.getDate(), DateConvertUtils.convertDateToWeek(miForecast.getDate())));
        ...
        weatherForecasts.add(new WeatherForecast(miForecast.getCityId(), miForecast.getWeather2(), weathers2[0],
                weathers2[1], temps2[0], temps2[1], miForecast.getWind2(), miForecast.getDate(), DateConvertUtils.convertDateToWeek(miForecast.getDate())));
        ...
        weatherForecasts.add(new WeatherForecast(miForecast.getCityId(), miForecast.getWeather3(), weathers3[0],
                weathers3[1], temps3[0], temps3[1], miForecast.getWind3(), miForecast.getDate(), DateConvertUtils.convertDateToWeek(miForecast.getDate())));
        ...
        weatherForecasts.add(new WeatherForecast(miForecast.getCityId(), miForecast.getWeather4(), weathers4[0],
                weathers4[1], temps4[0], temps4[1], miForecast.getWind4(), miForecast.getDate(), DateConvertUtils.convertDateToWeek(miForecast.getDate())));
        ...
        weatherForecasts.add(new WeatherForecast(miForecast.getCityId(), miForecast.getWeather5(), weathers5[0],
                weathers5[1], temps5[0], temps5[1], miForecast.getWind5(), miForecast.getDate(), DateConvertUtils.convertDateToWeek(miForecast.getDate())));
        ...
        weatherForecasts.add(new WeatherForecast(miForecast.getCityId(), miForecast.getWeather6(), weathers6[0],
                weathers6[1], temps6[0], temps6[1], miForecast.getWind6(), miForecast.getDate(), DateConvertUtils.convertDateToWeek(miForecast.getDate())));
    ...
    public List<LifeIndex> getLifeIndexes() {
        ...
        for (MiIndex miIndex : miWeather.getIndexList()) {
            lifeIndices.add(new LifeIndex(cityId, miIndex.getName(), miIndex.getIndex(), miIndex.getDetails()));
        }
        return lifeIndices;
    }
