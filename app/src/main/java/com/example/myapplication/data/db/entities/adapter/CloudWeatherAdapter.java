...
public class CloudWeatherAdapter extends WeatherAdapter {
    ...
    public CloudWeatherAdapter(EnvironmentCloudWeatherLive cloudWeatherLive, EnvironmentCloudForecast cloudForecast,
    ...
    public WeatherLive getWeatherLive() {
        ...
        weatherLive.setFeelsTemp(cloudWeatherLive.getFeelsTemperature());
        ...
        weatherLive.setTime(DateConvertUtils.dateToTimeStamp(cloudWeatherLive.getUpdateTime(),
                DateConvertUtils.DATE_FORMAT_PATTEN_YYYY_MM_DD_HH_MM));
    ...
    public List<WeatherForecast> getWeatherForecasts() {
        ...
        for (EnvironmentCloudForecast.ForecastEntity forecastEntity : cloudForecast.getForecast()) {
            ...
            weatherForecast.setTempMax(forecastEntity.getTmp().getMax());
            weatherForecast.setTempMin(forecastEntity.getTmp().getMin());
            ...
            weatherForecast.setWeek(DateConvertUtils.convertDateToWeek(forecastEntity.getDate()));
            weatherForecast.setDate(DateConvertUtils.convertDateToString(forecastEntity.getDate()));
    ...
    public AirQualityLive getAirQualityLive() {
        ...
        airQualityLive.setAqi(Integer.parseInt(cloudCityAirLive.getApi()));
